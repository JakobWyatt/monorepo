...
// Gray code is a binary code where each successive value differs by only one
// bit. Generate a gray code given a number of bits n. e.g. n == 2 00 01 11 10
...
// n == 4 0101 0100 0110 0010 0000 0001 0011 0111 1111 1011 1001 1000 1010 1110
// 1100 1101 rot 7, 1 past the middle 2 ^ (4 - 1) - 1
...
std::deque<uint64_t> GenerateGrayCode(int n)
{
    ...
    for (int64_t i = static_cast<int64_t>(halfSz) - 1; i >= 0; --i) {
        last.push_back(last.at(static_cast<size_t>(i)) + halfSz);
    }
